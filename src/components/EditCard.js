...
export default function EditCard() {
  ...
  const handleSubmit = async(e)=>{
    ...
    let response = (await axios.patch(`http://localhost:8080/api/updateimage/${id}`)).data
    if(response.status==="success"){
      alert(response.msg)
    }
  }
  ...
  return (
    <div className='pt-16 px-16 ml-20 flex flex-col items-center     w-4/6'>
          ...
          <h2 className="text-4xl pt-5 pb-4  text-orange-700 lg:text-4xl font-bold leading-7  ">Edit Image Detail</h2>
